  ...
  return (
    <div className="page-about" style={{ paddingTop: '120px', minHeight: '80vh', paddingBottom: 'var(--spacing-xl)' }}>
      ...
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <div className="image-reveal" style={{ margin: 'var(--spacing-lg) 0 var(--spacing-xl) 0', border: '1px solid var(--border-color)', overflow: 'hidden', aspectRatio: '16/7', position: 'relative' }}>
          <img 
